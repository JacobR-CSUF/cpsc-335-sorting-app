...
class UIComponents:
    ...
    def draw_console_panel(self, console_panel, console_messages):
    ...
    def draw_quit_button(self, quit_button):
        """Draw the QUIT button"""
        pygame.draw.rect(self.screen, COLORS['RED'], quit_button, border_radius=5)
